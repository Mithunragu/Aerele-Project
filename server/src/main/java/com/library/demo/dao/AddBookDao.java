...
//					System.out.println(jsonArray);
	...
	@Override
	public Responses updateAllBook(AddBookModel result) {
		...
		try {
			...
			try (Connection conn = DriverManager.getConnection(url, user, pass);
				...
				String updatebookQuery ="UPDATE library_management.add_book  SET\r\n"
						+ "imagelink ='"+result.getImageLink()+"' ,title ='"+result.getTitle()+"' ,author ='"+result.getAuthor()+"' ,quantity ="+result.getQuantity()+" ,rentfee ="+result.getRentFee()+" ,updated_date ='"+result.getUpdatedDate()+"' WHERE book_id = "+result.getBookId()+";";
