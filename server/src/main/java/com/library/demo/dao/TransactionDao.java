		...
		try {
			...
			try (Connection conn = DriverManager.getConnection(url, user, pass);
				...
				while (rs.next()) {
					...
					jsonobject.put("tId", rs.getString("t_id"));
					jsonobject.put("bookId", rs.getString("book_id"));
					jsonobject.put("memberId", rs.getString("member_id"));
					jsonobject.put("transDate", rs.getString("trans_date"));
					jsonobject.put("dueDay", rs.getInt("due_day"));
					jsonobject.put("outstandingDebt", rs.getInt("out_debt"));
					jsonobject.put("fineAmount", rs.getString("fine_amount"));
					jsonobject.put("status", rs.getString("status"));
					jsonobject.put("dueDate", rs.getString("due_date"));
					jsonobject.put("returnDate", rs.getString("return_date"));
