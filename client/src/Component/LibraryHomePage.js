                ...
                <div className="row justify-content-center m-2">
                    <div class="card col-lg-2 m-3 card-size bg-dark">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white" >You can add Students Details</p>
                    ...
                    <div class="card col-lg-2 m-3 card-size bg-dark">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white">You can fill in the details based on the Book.</p>
                    ...
                    <div class="card col-lg-2 m-3 card-size bg-dark">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white">You can Fill in the Issue Book.</p>
                    ...
                    <div class="card col-lg-2 m-3 card-size bg-dark">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-white" >You can view all the Transaction details  .</p>
