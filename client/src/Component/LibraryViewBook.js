                    ...
                    <tbody>
                        {
                            book.map((value,index)=>(
                                ...
                                <td>{value.rentFee}</td>
                                <td><Link to={`/LibraryUpdateBook/${value.bookId}`}  className='btn btn-success'>Edit</Link><Link to='' className='btn btn-danger m-1' onClick={()=>{handledeletebook(value.bookId)}}>Delete</Link></td>
                            </tr>
                            </>
                            ))
                        }
